  ...
  list.forEach(product => {
    let card = $(`
      <div class="bg-white shadow-md rounded-lg p-4 text-center hover:shadow-xl transition cursor-pointer">
        <img src="https://maroon-salmon-407117.hostingersite.com/static/upload/${product.prod_img}" 
    ...
    card.on("click", function() {
      $("#modalImage").attr("src", `https://maroon-salmon-407117.hostingersite.com/static/upload/${product.prod_img}`);
...
$(document).ready(function () {
  // Fetch products
  $.ajax({
    url: "https://maroon-salmon-407117.hostingersite.com/controller/end-points/controller.php?requestType=fetch_all_product",
    method: "GET",
    dataType: "json",
